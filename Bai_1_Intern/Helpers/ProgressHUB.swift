...
public class ProgressHUD: UIView {
    ...
    private var colorStatus        = UIColor.systemBlue
    ...
    private var imageSuccess    = UIImage()//UIImage.checkmark.withTintColor(UIColor.systemGreen, renderingMode: .alwaysOriginal)
